...
int main()
{
    ...
    // GLuint cubeProgramID = LoadShaders("2.1.basic_lighting.vs", "2.1.basic_lighting.fs");
    // GLuint lampProgramID = LoadShaders("2.1.lamp.vs", "2.1.lamp.fs");
    GLuint cubeProgramID = LoadShaders("2.2.basic_lighting.vs", "2.2.basic_lighting.fs");
    GLuint lampProgramID = LoadShaders("2.2.lamp.vs", "2.2.lamp.fs");
